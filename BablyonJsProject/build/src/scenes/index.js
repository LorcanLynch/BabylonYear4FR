...
var Game = /** @class */ (function () {
    ...
    function Game() {
        ...
        this._bindEvents();
        this._loadScene("../scene/scene.babylon");
    }
    /**
     * Loads the first scene.
     */
    Game.prototype._loadScene = function (sceneLocation) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.scene = null;
                        this.scene = new core_1.Scene(this.engine);
                        return [4 /*yield*/, (0, tools_1.appendScene)(this.scene, rootUrl, sceneLocation)];
                    case 1:
                        _a.sent();
                        // Attach camera.
